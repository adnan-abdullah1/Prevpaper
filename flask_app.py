...
"""
    class Results(Table):
        ...
        id = Col('sno', show=False)
        batch = Col('batch')
        paper_ext = Col('paper_ext')
        papertype = Col('papertype')
        subject = Col('subject')
        paper = Col('paper')
"""
class sem1(db.Model):
...
def download_paper(sno):
    ...
    if sem=="semster1":
        ...
        return send_file(BytesIO(sem1.query.all()[sno].paper),
        attachment_filename=sem1.query.all()[sno].paper_ext,as_attachment="True")
        

    if sem=='semster2':         
        print(" selected sem is sem2 paper name is ",sem2.query.all()[sno].paper_ext)                    
        return send_file(BytesIO(sem2.query.all()[sno].paper),
        attachment_filename=sem2.query.all()[sno].paper_ext,as_attachment="True")
    if __sem_keep=='semster3': 
        print(" sem3is selected")                            
        return send_file(BytesIO(sem3.query.all()[sno].paper),
        attachment_filename=sem3.query.all()[sno].paper_ext,as_attachment="True")
    if __sem_keep=='semster4':  
        print(" i am selected ")                           
        return send_file(BytesIO(sem4.query.all()[sno].paper),
        attachment_filename=sem4.query.all()[sno].paper_ext,as_attachment="True")
    if __sem_keep=='semster5':  
        print(" sem 5 is ssssss")                           
        return send_file(BytesIO(sem5.query.all()[sno].paper),
        attachment_filename=sem5.query.all()[sno].paper_ext,as_attachment="True")
    if __sem_keep=='semster6':                             
        return send_file(BytesIO(sem6.query.all()[sno].paper),
        attachment_filename=sem6.query.all()[sno].paper_ext,as_attachment="True")
    if __sem_keep=='semster7':                             
        return send_file(BytesIO(sem7.query.all()[sno].paper),
        attachment_filename=sem7.query.all()[sno].paper_ext,as_attachment="True")
    if __sem_keep=='semster8':                             
        return send_file(BytesIO(sem8.query.all()[sno].paper),
        attachment_filename=sem8.query.all()[sno].paper_ext,as_attachment="True")
